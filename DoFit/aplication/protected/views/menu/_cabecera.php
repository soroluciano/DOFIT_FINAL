<div class="cabecera-perfil">
		...
		<div class='profile_publicaciones contorno'>
				<ul class="contorno">
		...
		<div class='profile_friends_fotos'>
				<ul class="contorno">
						<li><a href='<?php echo Yii::app()->request->baseUrl;?>/red/index' style="cursor:pointer;"><span class="glyphicon glyphicon-globe blue"></span><span class="alerta_new" id="notificacion"></span>Notificaciones</a></li>		
						<li><a href='<?php echo Yii::app()->request->baseUrl;?>/galeria/index' style="cursor:pointer;"><span class="glyphicon glyphicon-picture light-green"></span>Imagenes</a></li>
				</ul>
		</div>
